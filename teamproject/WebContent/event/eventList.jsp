	...
	<article style="">
        ...
        <div style="width: 100vw; display: flex; justify-content: center; align-items: flex-start;">
            <div style="min-width: 1200px; max-width: 1400px;">
                <span>총 ${fn:length(eventList)}</span>
                <hr>
                <div class="card_small_board" >
                    <div>
                        ...
                        <!-- 복붙할영역 -->
                        <div class="card_small_board_div" onclick="location.href='${path0}/GetEvent.do?no=${dto.no}'"> 
                            <div style="height:360px;">
                            
                                <div class="card_small_board_div_img">
                                    <img src="${path0 }/eventUpload/${dto.photo}" alt="" />
                                </div>
                                <div class="card_small_board_div_txt">
                                    <h3>${dto.title}</h3>
                                    <p>${dto.ondate }</p>&nbsp;<p>${dto.tel }</p>
            ...
            <ul class="pagination justify-content-center">
                <c:choose>
                    <c:when test="${currentPage > 1}">
                        <li class="page-item">
                            <a class="page-link" href="${path0}/EventList.do?page=${currentPage - 1}" aria-label="Previous">
                ...
                <c:forEach begin="1" end="${totalPages}" var="i">
                    <li class="page-item ${i == currentPage ? 'active' : ''}">
                        <a class="page-link" href="${path0}/EventList.do?page=${i}">${i}</a>
                    </li>
                </c:forEach>
                ...
                <c:choose>
                    <c:when test="${currentPage < totalPages}">
                        <li class="page-item">
                            <a class="page-link" href="${path0}/EventList.do?page=${currentPage + 1}" aria-label="Next">
