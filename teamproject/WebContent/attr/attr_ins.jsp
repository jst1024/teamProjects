...
#page1 { background-color:#FFF; margin-bottom:250px; }
...
<div id="contents">
	<section class="page" id="page1">
		<div style="width:1400px; margin:0 auto;">
			...
			<form method="post" encType = "multipart/form-data" action="${path0 }/AttrIns.do">
				<table class="table">
					<tbody>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="traffic" id="traffic" class="form-control" maxlength="500" ></td>
						</tr>
						<tr>
							<th><label for="fee">이용요금</label></th>
							<td><input type="text" name="fee" id="fee" class="form-control" maxlength="250" required></td>
						</tr>
						<tr>
							<th><label for="tips">여행꿀팁</label></th>
							<td><input type="text" name="tips" id="tips" class="form-control" maxlength="500" ></td>
						</tr>
						<tr>
