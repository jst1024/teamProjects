...
<div class="wholeBox">
	...
	<div class="title-area">
		...
		<div class="">
	        <span style="float: right; display: block; font-size: 18px; margin-bottom:10px; margin-right:20px;">방문 수 : ${food.visited}</span>
	    </div>
	</div>
	...
	<div class="photo-area">
	    <div class="image-wrapper">
	        <img src="${path0}/foodUpload/${food.photo}" alt="사진여기있잖아왜안뜨는데" />
	    </div>
	</div>
	...
	<div class="btn-group" style="float: right;">
	  <c:if test="${sid == 'admin'}">
		  <a href="${path0 }/food/food_ins.jsp" class="btn btn-secondary">글 등록</a>
	...
	<div class="board-contents">
		...
		<div class="info-area">
			<h3>상세정보</h3>
			<span>▶&nbsp;&nbsp;<strong>주소 : </strong>&nbsp;&nbsp;${food.addr }</span><br>
			<span>▶&nbsp;&nbsp;<strong>대표메뉴 :</strong> &nbsp;&nbsp;${food.mainmenu }</span><br>
			<span>▶&nbsp;&nbsp;<strong>연락처 : </strong>&nbsp;&nbsp;${food.tel }</span><br>
			<span>▶&nbsp;&nbsp;<strong>운영 요일 : </strong>&nbsp;&nbsp;${food.ontime }</span><br>
		</div>
	</div>
	<hr>
	<!-- 지도(api) -->
